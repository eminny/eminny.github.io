<template>
  ...
  <div>
    <section>
      <h1 class="section__heading--alpha">Privacy Policy</h1>
      <hr>
      <h3>CANDER PARIS IS COMMITTED TO PROTECTING YOUR PRIVACY.<br>OUR OFFICIAL PRIVACY POLICIES ARE AS FOLLOWS:</h3>
